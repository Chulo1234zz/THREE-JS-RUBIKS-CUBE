  ...
  3: {
    checkerboard: {
      ...
      positions: [
        ...
        { x: 0, y: -1/3, z: -1/3 },//16
        { x: 0, y: 1/3, z: 0 },//17
        { x: -1/3, y: -1/3, z: 1/3 },//18
        { x: 1 / 3, y: 1 / 3, z: 0 },//19
        { x: -1 / 3, y: -1 / 3, z: -1 / 3 },//20
        { x: 1/3, y: 0, z: -1/3 },//21

      ],
      rotations: [
        { "x": -Math.PI, "y": 0, "z": Math.PI, },//1
        { "x": Math.PI, "y": 0, "z": 0 },//2
        { "x": -Math.PI, "y": 0, "z": Math.PI },//3,
        { "x": 0, "y": 0, "z": 0 },//4
        { "x": 0, "y": 0, "z": Math.PI },//5
        { "x": 0, "y": 0, "z": 0 },//6
        { "x": -Math.PI, "y": 0, "z": 0 },//7
        { "x": Math.PI, "y": 0, "z": 0 },//8
        { "x": -Math.PI, "y": 0, "z": Math.PI },//9
        { "x": 0, "y": 0, "z": Math.PI },//10
        { "x": 0, "y": 0, "z": 0 },//11
        { "x": 0, "y": 0, "z": Math.PI },//12
        { "x": -Math.PI, "y": 0, "z": 0 },//13
        {"x": Math.PI,"y":0,"z":Math.PI },//14
        { "x": Math.PI, "y": 0, "z": 0 },//15
        { "x": 0, "y": 0, "z": Math.PI },//16
        { "x": 0, "y": 0, "z": 0 },//17
        { "x": 0, "y": 0, "z": Math.PI },//18
        { "x": Math.PI, "y": 0, "z": 0 },//19
        { "x": -Math.PI, "y": 0, "z": 0 },//20
        { "x": Math.PI, "y": 0, "z": Math.PI },//21
        { "x": 0, "y": 0, "z": 0 },//22
        { "x": Math.PI, "y": 0, "z": 0 },//23
        { "x": 0, "y": 0, "z": 0 },//24
        { "x":Math.PI, "y": 0, "z": Math.PI },//25
        { "x": -Math.PI, "y": 0, "z": 0 },//26
        { "x": Math.PI, "y": 0, "z": Math.PI },//27
      ],
      size: 3,
    },
  }
};
// Rw U2 x Rw U2 Rw U2 Rw' U2 Lw U2 Rw' U2 Rw U2 Rw' U2 Rw'  //oll parity for 4x4

// pll parity for 4 x 4
